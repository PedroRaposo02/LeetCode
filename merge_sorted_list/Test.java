...
public class Test {
    ...
    /*
     * Won't Run all the tests cause of wrong implementation of ListNode to mimick
     * LeetCode's ListNode
     */
    public static void main(String[] args) {
        ...
        testCases.forEach((input, output) -> {
            ListNode result = s.mergeTwoLists(input.getFirstPrivate(), input.getSecondPrivate());
